...
public class ProductionOrder {
    ...
    public ProductionOrder(int id, int planQty, Date startDate, Date endDate, String priority, String status, BomStyle bomStyle, Order order, List<CuttingPlan> cuttingPlans) {
        this.id = id;
